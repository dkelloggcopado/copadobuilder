...
export default class CopadoBuilderChat extends NavigationMixin(LightningElement) {
  ...
  /**
   * Once per chat: preselect a personal/preferred Copado AI integration.
   * Does NOT auto-mark Org Context Connected — user must Connect with an org
   * credential they own (Copado AI credentials are per-user).
   */
  async checkExistingOrgIntelligence() {
    ...
    // Prefer personal match, then connected User Level, then any connected — picker only.
    const matched =
      personalConnected
